...
File f=new File("G:/Eclipse Workspace/storeappfinal1/WebContent/filesclasses.txt");
 if(!f.exists()){
	  f.createNewFile();
  }
...
try {
	...
	if (request.getParameter("name") != null && request.getParameter("id") != null) {
		...
		String deposite=request.getParameter("dmoney");
		...
		if(rs.next()){
			int cost=Integer.parseInt(rs.getString("deposite"));
			sql="UPDATE student_details SET parent_phone='"+phone+"', class='"+class1+"' , name='"+name+"', deposite='"+(cost+Integer.parseInt(deposite))+"'  WHERE";
			sql=sql+" id='"+id+"';";
			int r=stmt.executeUpdate(sql);
			
			if(r>0){
				out.print("<center>Updated successfully</center>");
			}else{
				out.print("updating failed");
			}
		}else{
			sql="insert into student_details values('"+id+"','"+class1+"','"+name+"','"+pname+"','"+phone+"','"+deposite+"');";			
			int r = stmt.executeUpdate(sql);
			if(r>0){
				out.print("<center>added successfully</center>");
			}else{
...
%>
  ...
  <div style="">
    ...
    <div class="card">
        ...
        <center> <h4 class="mb-3">Add Student</h4></center> 
          </div>
           <div class="card-body">
          <form action="addStudent.jsp" method="post" class="needs-validation" novalidate>
            <div class="row">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                <input type="text" class="form-control" name="pname" placeholder="Parent Name" required>
                <div class="invalid-feedback" style="width: 100%;">
                  Your Parent Name is required.
                </div>
              </div>
            </div>
   ...
   <div class="row">
            <div class="col-md-6 mb-3">
              <label for="pricefromstore">Deposite</label>
            ...
            <div class="col-md-6 mb-3">
              <label for="pricetoschool">Id <span class="text-muted"></span></label>
