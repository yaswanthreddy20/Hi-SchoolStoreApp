...
File f=new File("G:/Eclipse Workspace/storeappfinal1/WebContent/files/classes.txt");
 if(!f.exists()){
	  f.createNewFile();
  }
...
try {
	...
	if (request.getParameter("itemname") != null && request.getParameter("class") != null) {
		...
		String fromstore=request.getParameter("tostudents");
		String toschool=request.getParameter("toschool");
		String count=request.getParameter("count");
		String med=request.getParameter("meduim");
		String storename=request.getParameter("store");
		String sql="SELECT * FROM stddetails WHERE itemname='"+itemname+"' AND class='"+class1+"' AND itemtype='"+itemtype+"' AND meduim='"+med+"';";
		Statement stmt = con.createStatement();
		ResultSet rs=stmt.executeQuery(sql);
		boolean fl=true;
		if(rs.next()){
			int i=Integer.parseInt(rs.getString("countitems"));
			sql="UPDATE stddetails SET mrp='"+mrp+"', fromstore='"+fromstore+"' , toschool='"+toschool+"', countitems='"+(i+Integer.parseInt(count))+"'  WHERE";
			sql=sql+" itemname='"+itemname+"' AND class='"+class1+"' AND itemtype='"+itemtype+"' AND meduim='"+med+"';";
			int r=stmt.executeUpdate(sql);
			
			if(r>0){
				out.print("<center>Updated successfully");
				sql="";
			}else{
				out.print("<center>adding failed");
				fl=false;
			}
		}else{
			sql="insert into stddetails values('"+itemname+"','"+class1+"','"+itemtype+"',"+mrp+","+fromstore+","+toschool+","+count+",'"+med+"');";
			
			int r = stmt.executeUpdate(sql);
			if(r>0){
				out.print("<center>added successfully");
			}else{
				fl=false;
				out.print("<center>adding failed");
			}
		...
		if(fl){
			int amount=Integer.parseInt(fromstore)*Integer.parseInt(count);
			sql="INSERT INTO stdstorepurchase  values('"+storename+"','"+itemname+"','"+class1+"','"+itemtype+"','"+fromstore+"','"+count+"','"+med+"', '"+amount+"');";
			int r=stmt.executeUpdate(sql);
			if(r>0){
				out.print("added successfully</center>");
			}else{
				out.print("adding failed</center>");
			}
		}
...
%>
  ...
  <div style="">
    ...
    <div class="card">
        ...
        <center> <h4 class="mb-3">Add Product</h4></center> 
          </div>
           <div class="card-body">
          <form action="addStandard.jsp" method="post" class="needs-validation" novalidate>
            <div class="row">
              <div class="col-md-6 mb-3">
                <label for="itemname">Item Name</label>
                <input type="text" class="form-control" name="itemname" placeholder="Item Name" value="" required>
             ...
             <div class="col-md-6 mb-3">
                ...
                <select class="custom-select d-block w-100" name="class" required>
                 ...
                 <%
					...
					//	if(request.getParameter("class").equals(s)){
            ...
            <div class="mb-3">
              ...
              <input type="mrp" class="form-control" name="mrp" placeholder="MRP" required>
              <div class="invalid-feedback">
                Please enter MRP.
              </div>
            </div>
   <div class="row">
            <div class="col-md-6 mb-3">
              <label for="pricefromstore">Price From Store</label>
              <input type="text" class="form-control" name="tostudents" placeholder="Price From Store" required>
              <div class="invalid-feedback">
            ...
            <div class="col-md-6 mb-3">
              <label for="pricetoschool">Price to School <span class="text-muted"></span></label>
              <input type="text" class="form-control" name="toschool" placeholder="Price to School">
            </div>
</div>
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <select class="custom-select d-block w-100" name="meduim" required>
                  <option value="">Choose...</option>
                  <option value="hid">HID</option>
					<option value="eng">ENG</option>
					<option value="eng">BOTH</option>
                </select>
                <div class="invalid-feedback">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" name="count" placeholder="Enter count" required>
                <div class="invalid-feedback">
