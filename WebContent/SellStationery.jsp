...
<script type="text/javascript">
    $(document).ready(function(){     
    	 $("#add-row").click(function(){
    	    	...
    	    	//}
    	    	//if(fl){
    	        var urli = "fetchStationery.jsp?iname="+itemname+"&itype="+itemtype;
    	        $.ajax({
    	        	type: 'GET',
    	        	url:urli,
    	        	dataType:'json',
    	        	success:function(res){
    	            	...
    	            	for(i=0;i<res.length;i++){
    	            		...
    	            		data+="<tr><td><input type='checkbox' name='record'></td><td><input type=\"hidden\" value=\""+p.iname+"\" name=\"iname[]\">"+p.iname+"</td><td><input type=\"hidden\" value=\""+p.itype+"\" name=\"itype[]\">"+p.itype+"</td><td><input type=\"hidden\" value=\""+p.mrp+"\" name=\"mrp[]\">"+p.mrp+"</td><td><input type=\"text\" value=\""+qty+"\" name=\"qty[]\" onchange=\"cal()\"></td></tr>";
    	            	}
...
try {
	...
	ResultSet rs;
	String sql="SELECT * FROM statdetails;";
	...
	<form action="SellStationery_action.jsp" method="get">
	<div class="row">
