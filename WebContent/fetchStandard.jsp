	...
	<%
		try {
			...
			try {
				...
				query = "SELECT * FROM stddetails WHERE itemname='"+request.getParameter("iname")+"' AND class='"+request.getParameter("class")+"' AND itemtype='"+request.getParameter("itype")+"';";
				//out.print("1");
				...
				if (!result.next()) {
					...
					JSONArray array = new JSONArray();
						...
						obj.put("class1", result.getString("class"));
