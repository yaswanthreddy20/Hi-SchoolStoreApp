  ...
  <body>
   ...
   <nav class="side-navbar">
    ...
    <div class="page">
      ...
      <!-- Statistics Section-->
      <section class="statistics" style="padding-top:0.25cm">
        <div class="container-fluid">
          <div class="row d-flex">
            <div class="col-lg-4">
              <!-- Income-->
              <div class="card income text-center">
                <div class="icon"><img src="./img/icons/addstandard1.png"></div>
				<p>Enter this section to<strong class="text-warning"> ADD STANDARD</strong> products</p>
				<a href="addStandard.jsp" class="btn btn-outline-primary"><strong>ADD</strong></a>
            ...
            <div class="col-lg-4">
              ...
              <div class="card income text-center">
				...
				<p>Enter this section to <strong class="text-success">SELL STANDARD</strong> products</p>
				<a href="SellStandard.jsp" class="btn btn-outline-primary"><strong>SELL</strong></a>
			...
			<div class="col-lg-4">
              ...
              <div class="card income text-center">
				...
				<p>Enter this section to <strong class="text-danger">EXPORT STANDARD</strong> product details</p>
				<a href="exportExpand.jsp" class="btn btn-outline-primary"><strong>EXPORT</strong></a>
        ...
        <div class="container-fluid">
          <div class="row d-flex">
            <div class="col-lg-4">
              <!-- Income-->
              <div class="card income text-center">
                <div class="icon"><img src="./img/icons/addstationery.png"></div>
				<p>Enter this section to<strong class="text-warning"> ADD STATIONERY</strong> products</p>
				<a href="addStationery.jsp" class="btn btn-outline-primary"><strong>ADD</strong></a>
            ...
            <div class="col-lg-4">
              <!-- Income-->
              <div class="card income text-center">
                <div class="icon"><img src="./img/icons/sellstationery.png"></div>
				<p>Enter this section to <strong class="text-success">SELL STATIONERY</strong> products</p>
				<a href="home.jsp" class="btn btn-outline-primary"><strong>SELL</strong></a>
			...
			<div class="col-lg-4">
              <!-- Income-->
              <div class="card income text-center">
                <div class="icon"><img src="./img/icons/print1.png"></div>
				<p>Enter this section to <strong class="text-danger">EXPORT STATIONERY</strong> product details</p>
				<a href="exportExpand.jsp?type=std" class="btn btn-outline-primary"><strong>EXPORT</strong></a>
        ...
        <div class="container-fluid">
          <div class="row d-flex">
           ...
           <div class="col-lg-4">
              <!-- Income-->
              <div class="card income text-center">
                <div class="icon"><img src="./img/icons/add.png"></div>
				<p>Enter this section to<strong class="text-warning"> USER MANAGEMENT</strong> </p>
				<a href="UserManagement.jsp" class="btn btn-outline-primary"><strong>USERS</strong></a>
            ...
            <div class="col-lg-4">
              <!-- Income-->
              <div class="card income text-center">
                <div class="icon"><img src="./img/icons/changepassword.png"></div>
				<p>Enter this section to <strong class="text-success">UPDATE PASSWORD</strong></p>
				<a href="#" class="btn btn-outline-primary"><strong>CHANGE</strong></a>
			...
			<div class="col-lg-4">
              <!-- Income-->
              <div class="card income text-center">
                <div class="icon"><img src="./img/icons/parentmanagement.png"></div>
				<p>Enter this section to update <strong class="text-danger">STUDENT INFO</strong></p>
				<a href="#" class="btn btn-outline-primary"><strong>STUDENT MANAGEMENT</strong></a>
